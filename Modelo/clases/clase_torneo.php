...
class torneo{
    ...
    */
    ...
    /**
    * Muestra los torneos asociados a una categoría específica.
    *
    * @param int $id_categoria El ID de la categoría de la cual se quieren obtener los torneos.
    * @param mysqli $conexion La conexión a la base de datos.
    *
    * @return array Un array con los detalles de los torneos si se encuentran, o un array vacío si no hay torneos.
    */
    public function mostrar_torneos($id_categoria, $conexion){
        ...
        // Devolver torneos si encuentra(array vacio si no se encontró).
        return $torneos;
    }
